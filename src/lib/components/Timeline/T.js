export const toFixed2 = (i) => parseInt(i * 100) / 100;
export default function TimeLine(
  ...
  function Square(x, y, edge, index, text, sIndex, eIndex) {
    ...
    this.draw = (context) => {
      ...
      if (this.selected) context.fillStyle = "white";

      //High usage! fittingString()
      if (
        this.edge > 20 &&
  ...
  function animate() {
    ...
    if (beginingTimeShow > endTime) shift = endTime - beginingTimeShow;
